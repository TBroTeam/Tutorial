...
![Expression Barplot for a single Isoform](figures/barplot_iso.png)
...
![Differential expression](figures/diffexp.png)
...
![List of Pathways in the cart](figures/pathway.png)
...
![Combisearch](figures/combisearch.png)
...
![Blast interface](figures/blast.png)

[fig:blast]

![Blast results](figures/blast_results_1.png)

[fig:blast~r~esults~1~]

![Blast results](figures/blast_results_2.png)

[fig:blast~r~esults~2~]
